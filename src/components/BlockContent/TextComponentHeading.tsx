      ...
      >
        {headingNumber === "h1" && (
          <h1
            ...
            className={`text-gray-700 dark:text-white my-5 2xl:mb-2 2xl:mt-10 text-3xl md:text-4xl  text-center ${HeadingClassName}`}
          >
            {heading}
          </h1>
        )}
        {headingNumber === "h2" && (
          <h2
            ...
            className={`text-gray-700 dark:text-white my-5 2xl:mb-2 2xl:mt-10 text-2xl md:text-3xl text-center ${HeadingClassName}`}
          >
            {heading}
          </h2>
        )}
        ...
        {headingNumber === "h4" && (
          <h4
            ...
            className={`text-gray-700 dark:text-white my-5 2xl:mb-2 2xl:mt-10 text-xl md:text-2xl text-center ${HeadingClassName}`}
          >
            {heading}
          </h4>
        )}
        ...
        {headingNumber === "h6" && (
          <h6
            ...
            className={`text-gray-700 dark:text-white my-5 2xl:mb-2 2xl:mt-10 text-lg md:text-xl text-center ${HeadingClassName}`}
          >
            {heading}
          </h6>
        )}
